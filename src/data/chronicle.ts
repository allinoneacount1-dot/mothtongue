...
We wanted the player to feel the humidity of the forest, the cold of stone walls, the particular silence that exists inside a display case. Every environment has its own sound signature, built from real recordings and shaped to feel organic.
